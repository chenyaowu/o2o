...
import com.chen.o2o.service.ProductService;
...
public class ProductServiceImpl implements ProductService {
        ...
        if(product !=null && product.getShop() !=null && product.getShop().getShopId() !=null) {
            ...
            if (thumbnail != null) {
                ...
                if (tempProduct.getImgAddr() != null) {
                    ImgUtil.deleteFile(tempProduct.getImgAddr());
                }
    ...
    private void deleteProductImgList(Long productId) {
        ...
        for (ProductImg productImg:productImgList) {
            ImgUtil.deleteFile(productImg.getImgAddr());
        }
        //删除数据库里的图片
    ...
    private void addProductImgList(Product product, List<ImageHolder> imageHolderList) {
        ...
        for (ImageHolder productImgHolder:imageHolderList){
            String imgAddr = ImgUtil.generateNormalThumbnail(productImgHolder,desc);
    ...
    private void addThumbnail(Product product, ImageHolder imageHolder) {
        String desc = PathUtil.getShopImagePath(product.getShop().getShopId());
        String thumbnailAddr = ImgUtil.generateThumbnail(imageHolder,desc);
